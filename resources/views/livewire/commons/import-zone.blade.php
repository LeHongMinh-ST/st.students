    ...
    <form id="uploadForm" enctype="multipart/form-data">
        <div class="mb-3">
            ...
            <div class="p-4 text-center dropzone d-block" id="dropzoneFile" wire:ignore.self>
                ...
                <div>
                    ...
                    <input type="file" name="file" wire:model.live="file" class="d-none" id="fileInput"
                        accept=".xls,.xlsx,.csv">
                </div>
        ...
        @if (count($previewData) > 0)
            <div class="text-center" wire:transition>
                ...
                <button type="button" class="mt-3 btn btn-primary" wire:loading.remove wire:target="import"
                    wire:click="import">
                ...
                <button type="button" class="mt-3 btn btn-danger" wire:loading.remove wire:target="resetFile"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Đang nhập dữ liệu...</h5>
                </div>
