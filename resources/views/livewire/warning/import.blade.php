<div>
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0">Import sinh viên cảnh báo</h5>
        </div>
        <div class="card-body">
            <div class="alert alert-info">
                <div class="d-flex">
                    ...
                    <div>
                        ...
                        <p>
                            Tải file mẫu và điền thông tin sinh viên cảnh báo theo định dạng sau:
                            <ul>
                                <li>Cột A: Mã sinh viên</li>
                                <li>Cột B: Họ và tên</li>
                                <li>Cột C: Điểm trung bình (GPA)</li>
                                <li>Cột D: Lý do cảnh báo</li>
                            </ul>
                        </p>
                        <a href="{{ asset('templates/warning_students_template.xlsx') }}" class="btn btn-light">
            ...
            <form wire:submit.prevent="startImport">
                ...
                <div class="text-end">
                    <a href="{{ route('warnings.show', $warning->id) }}" class="btn btn-light">Hủy</a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <p class="mt-3">Hệ thống đang xử lý import sinh viên cảnh báo. Vui lòng đợi...</p>
                        <p>Bạn có thể đóng cửa sổ này và quay lại sau. Quá trình import vẫn tiếp tục trong hệ thống.</p>
                    </div>

                    <div class="modal-footer">
                        <button type="button" class="btn btn-light" data-bs-dismiss="modal">Đóng</button>
                        <a href="{{ route('warnings.show', $warning->id) }}" class="btn btn-primary">Quay lại danh sách</a>
                    </div>
                </div>
            </div>
        </div>
