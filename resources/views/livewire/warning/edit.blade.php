                ...
                <div class="col">
                    <div class="card">
                        <div class="card-header bold">
                            ...
                            Thông tin đợt cảnh báo
                        </div>
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    <label for="name" class="col-form-label">
                                        Tên đợt cảnh báo <span class="required text-danger">*</span>
                                    </label>
                                    <input wire:model="name" type="text" id="name"
                                           class="form-control @error('name') is-invalid @enderror" placeholder="Nhập tên đợt cảnh báo">
                                    @error('name')
            ...
            <div class="card">
                ...
                <div class="gap-2 card-body d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex gap-2 mt-2">
                        <a href="{{ route('warnings.index') }}" type="button" class="btn btn-warning flex-fill fw-semibold"><i
            ...
            window.addEventListener('onOpenDeleteModal', () => {
                new swal({
                    ...
                    if (value.isConfirmed) {
                        Livewire.dispatch('deleteWarning')
                    }
                })
            })
        </script>
