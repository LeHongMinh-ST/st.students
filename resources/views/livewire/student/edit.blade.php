                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input wire:model="training_type" type="text" id="training_type"
                                           class="form-control @error('training_type') is-invalid @enderror" placeholder="Nhập loại đào tạo">
                                    @error('training_type')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <input wire:model="social_policy_object" type="text" id="social_policy_object"
                                           class="form-control @error('social_policy_object') is-invalid @enderror" placeholder="Nhập đối tượng chính sách">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @elseif ($student->thumbnail)
                                        <div class="mt-2">
                                            <img src="{{ Storage::url($student->thumbnail) }}" class="img-fluid img-thumbnail" style="max-height: 100px;">
                                        </div>
                                    @endif
                                </div>
                            </div>
                ...
                <div class="card-body">
                    <div class="text-center mb-3">
                        @if ($student->thumbnail)
                            <img src="{{ Storage::url($student->thumbnail) }}" class="img-fluid rounded-circle" style="max-width: 150px;">
                        @else
            ...
            <div class="card mt-3">
                ...
                <div class="gap-2 card-body d-flex flex-column justify-content-center">
                    ...
                    <div class="d-flex gap-2 mt-2">
                        <a href="{{ route('students.show', $student->id) }}" type="button" class="btn btn-warning flex-fill fw-semibold"><i
