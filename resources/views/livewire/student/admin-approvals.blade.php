            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @if($currentRequest)
                        ...
                        @if($currentRequest->status === \App\Enums\StudentUpdateStatus::TeacherApproved)
                            <div class="mb-3">
                ...
                <div class="modal-footer">
                    ...
                    @if($currentRequest && $currentRequest->status === \App\Enums\StudentUpdateStatus::TeacherApproved)
