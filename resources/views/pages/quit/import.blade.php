<x-admin-layout>
            ...
            <div class="page-header-content d-lg-flex">
                <div class="d-flex">
                    <h4 class="page-title mb-0">
                        Quản lý thôi học <span class="fw-normal">Import sinh viên buộc thôi học</span>
                    </h4>
            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="py-2 breadcrumb">
                        ...
                        <a href="{{ route('quits.show', $quit->id) }}" class="breadcrumb-item">{{ $quit->name }}</a>
    ...
    <div class="content">
        <livewire:quit.import :quit="$quit" />
    </div>
</x-admin-layout>
