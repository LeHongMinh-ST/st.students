<x-admin-layout>
            ...
            <div class="page-header-content d-lg-flex">
                <div class="d-flex">
                    <h4 class="page-title mb-0">
                        Quản lý lớp học <span class="fw-normal">Import phân công giáo viên chủ nhiệm</span>
                    </h4>
            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="py-2 breadcrumb">
                        ...
                        <span class="breadcrumb-item active">Import phân công giáo viên</span>
                    </div>
    ...
    <div class="content">
        <livewire:class.import-teacher-assignment />
    </div>
</x-admin-layout>
